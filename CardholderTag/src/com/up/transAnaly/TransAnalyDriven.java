 ...
 * */
public class TransAnalyDriven extends Configured{
...
//		conf.set("dfs.namenode.rpc-address.nameservice1.namenode684", "bB0103003:8020");
		...
		Job job = new Job(conf, "Trans Analy");
		job.setJarByClass(TransAnalyDriven.class);
		
		job.setMapperClass(TransAnalyMapper.class);
		job.setReducerClass(TransAnalyReducer.class);
