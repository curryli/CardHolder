 ...
 * */
public class MapAPPDriven extends Configured{
...
//		conf.set("dfs.namenode.rpc-address.nameservice1.namenode684", "bB0103003:8020");
		...
		Job job = new Job(conf, "TransferAccount Tag---v1.1");
		job.setJarByClass(MapAPPDriven.class);
		
		job.setMapperClass(MapAPPMapper.class);
		job.setReducerClass(MapAPPReducer.class);
