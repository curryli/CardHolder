...
//		String card_md5 = MD5.GetMD5Code(card_num);						//MD5
		String card_md5 = "";
		try {
			 card_md5 = HmacMd5Util.getHmacMd5Bytes(Constant.MD5_KEY.getBytes(),this.reverse(card_num.trim()).getBytes(HmacMd5Util.UTF8));
		} catch (Exception e) {
	...
	public String reverse(String cardId){
		StringBuilder sb = new StringBuilder();
		sb.append(cardId);
		sb.reverse();
