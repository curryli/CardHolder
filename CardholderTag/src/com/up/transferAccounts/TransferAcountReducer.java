package com.up.transferAccounts;
...
public class TransferAcountReducer extends Reducer<Text,Text,Text,Text>{
	static private Logger logger = LoggerFactory
			.getLogger(TransferAcountReducer.class);
...
//		sb.append(errorMsg);
	...
	class TransItem{
		...
		private String tfr_out_acct_no; 			//转出卡号
		private String tfr_in_acct_no;				//转入卡号
		...
		public TransItem(String line){
			...
			this.tfr_out_acct_no = tokens[25].trim();
			this.tfr_in_acct_no = tokens[24].trim();
		...
		public String toString(){
			...
			sb.append(this.tfr_in_acct_no+Constant.separator_3);
