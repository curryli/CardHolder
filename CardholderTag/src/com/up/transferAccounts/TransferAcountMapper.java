...
public class TransferAcountMapper extends Mapper<Object, Text, Text, Text>{
...
//					System.out.println("trans_at is illegal，not all numerous!" + trans_at);
				...
				if(!this.isTransferAcountTrans(trans_id))
					return;
...
//				context.write(new Text(tfr_out_acct_no),new Text(sb.toString()));
