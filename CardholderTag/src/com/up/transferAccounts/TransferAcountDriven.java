 ...
 * */
public class TransferAcountDriven extends Configured{
...
//		conf.set("dfs.namenode.rpc-address.nameservice1.namenode684", "bB0103003:8020");
		...
		Job job = new Job(conf, "TransferAccount Tag");
		job.setJarByClass(TransferAcountDriven.class);
		
		job.setMapperClass(TransferAcountMapper.class);
		job.setReducerClass(TransferAcountReducer.class);
