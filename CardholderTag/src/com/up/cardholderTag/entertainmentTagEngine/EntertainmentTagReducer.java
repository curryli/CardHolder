...
public class EntertainmentTagReducer extends Reducer<Text,Text,Text,Text>{
...
//		}
	...
	public void reduce(Text key, Iterable<Text> lines, Context context) throws IOException, InterruptedException{
		...
		int bar_times = 0;												//酒吧消费次数
		float bar_sum = 0f;												//酒吧消费总金额
		float avg_bar_amount = 0f;										//酒吧次均消费金额
		String often_bar_name = TagUtility.NULL;						//最常光顾酒吧商户名
		int avg_bar_day_interval = -1;									//平均酒吧消费间隔
		int long_bar_day_interval = -1;									//最长酒吧消费间隔
		int short_bar_day_interval = -1;								//最短酒吧消费间隔
		String often_bar_time = TagUtility.NULL;						//最常酒吧消费时段
		String bar_time_record = TagUtility.NULL;						//酒吧消费记录
		String bar_record = TagUtility.NULL;							//泡吧指数
		int bar_index = -1;
		
		int cafe_times = 0;												//咖啡厅消费次数
		float cafe_sum = 0f;											//咖啡厅消费总金额
		float avg_cafe_amount = 0f;										//咖啡厅次均消费金额
		String often_cafe_name = TagUtility.NULL;						//最常光顾咖啡厅商户名
		String often_cafe_time = TagUtility.NULL;						//最常咖啡厅消费时段
		String cafe_time_record = TagUtility.NULL;						//咖啡厅消费时段记录
		String cafe_record = TagUtility.NULL;							//咖啡厅消费记录
		int cafe_index = -1; 											//小资指数
		
		int tea_times = 0;												//茶馆消费次数
		float tea_sum = 0f;												//茶馆消费总金额
		float avg_tea_amount = 0f;										//茶馆次均消费金额
		String often_tea_name = TagUtility.NULL;						//最常光顾茶馆商户名
		String often_tea_time = TagUtility.NULL;						//最常茶馆消费时段
		String tea_time_record = TagUtility.NULL;						//茶馆消费时段记录
		String tea_record = TagUtility.NULL;							//茶馆消费记录
		int tea_index = -1; 											//喝茶指数
		
		int ktv_times = 0;												
		float ktv_sum = 0f;
		float avg_ktv_amount = 0f;
		String ktv_time_record = TagUtility.NULL;
		String ktv_record = TagUtility.NULL;
		int ktv_index = -1; 
		
		int club_times = 0;
		float club_sum = 0f;
		float avg_club_amount = 0f;
		String club_time_record = TagUtility.NULL;
		String club_record = TagUtility.NULL;
		int club_index = -1; 
		
		int massage_times = 0;
		float massage_sum = 0f;
		float avg_massage_amount = 0f;
		String massage_time_record = TagUtility.NULL;
		String massage_record = TagUtility.NULL;
		int massage_index = -1; 
		
		int night_index = -1;
		String night_type_record = TagUtility.NULL;
		String night_detail_record = TagUtility.NULL;
		
		
		
		
		ArrayList<TransItem> barList = new ArrayList<TransItem>();
		ArrayList<TransItem> cafeList = new ArrayList<TransItem>();
		ArrayList<TransItem> teaList = new ArrayList<TransItem>();
		ArrayList<TransItem> ktvList = new ArrayList<TransItem>();
		ArrayList<TransItem> clubList = new ArrayList<TransItem>();
		ArrayList<TransItem> massageList = new ArrayList<TransItem>();
		ArrayList<TransItem> fitList = new ArrayList<TransItem>();
		ArrayList<TransItem> yogaList = new ArrayList<TransItem>();
		ArrayList<TransItem> golfList = new ArrayList<TransItem>();
		...
		sb.append(bar_times+Constant.separator_1);									
		sb.append(bar_sum+Constant.separator_1);	
		sb.append(avg_bar_amount+Constant.separator_1);	
		sb.append(often_bar_name+Constant.separator_1);	
		sb.append(avg_bar_day_interval+Constant.separator_1);									
		sb.append(long_bar_day_interval+Constant.separator_1);	
		sb.append(short_bar_day_interval+Constant.separator_1);	
		sb.append(often_bar_time+Constant.separator_1);	
		sb.append(bar_time_record+Constant.separator_1);									
		sb.append(bar_record+Constant.separator_1);	
		sb.append(bar_index+Constant.separator_1);	
		
		sb.append(cafe_times+Constant.separator_1);	
		sb.append(cafe_sum+Constant.separator_1);									
		sb.append(avg_cafe_amount+Constant.separator_1);	
		sb.append(often_cafe_name+Constant.separator_1);	
		sb.append(often_cafe_time+Constant.separator_1);	
		sb.append(cafe_time_record+Constant.separator_1);	
		sb.append(cafe_record+Constant.separator_1);									
		sb.append(cafe_index+Constant.separator_1);	
		
		sb.append(tea_times+Constant.separator_1);	
		sb.append(tea_sum+Constant.separator_1);	
		sb.append(avg_tea_amount+Constant.separator_1);									
		sb.append(often_tea_name+Constant.separator_1);									
		sb.append(often_tea_time+Constant.separator_1);	
		sb.append(tea_time_record+Constant.separator_1);	
		sb.append(tea_record+Constant.separator_1);	
		sb.append(tea_index+Constant.separator_1);	
		
		sb.append(ktv_times+Constant.separator_1);	
		sb.append(ktv_sum+Constant.separator_1);	
		sb.append(avg_ktv_amount+Constant.separator_1);						
		sb.append(ktv_time_record+Constant.separator_1);	
		sb.append(ktv_record+Constant.separator_1);	
		sb.append(ktv_index+Constant.separator_1);	
		
		sb.append(club_times+Constant.separator_1);									
		sb.append(club_sum+Constant.separator_1);	
		sb.append(avg_club_amount+Constant.separator_1);	
		sb.append(club_time_record+Constant.separator_1);									
		sb.append(club_record+Constant.separator_1);	
		sb.append(club_index+Constant.separator_1);	
		
		sb.append(massage_times+Constant.separator_1);	
		sb.append(massage_sum+Constant.separator_1);									
		sb.append(avg_massage_amount+Constant.separator_1);	
		sb.append(massage_time_record+Constant.separator_1);	
		sb.append(massage_record+Constant.separator_1);	
		sb.append(massage_index+Constant.separator_1);	
		
		sb.append(night_index+Constant.separator_1);	
		sb.append(night_type_record+Constant.separator_1);	
		sb.append(night_detail_record+Constant.separator_1);	
