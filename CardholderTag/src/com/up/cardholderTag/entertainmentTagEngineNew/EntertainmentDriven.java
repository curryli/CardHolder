...
public class EntertainmentDriven extends Configured{
...
//		conf.set("dfs.namenode.rpc-address.nameservice1.namenode684", "bB0103003:8020");
		...
		Job job = new Job(conf, "Entertainment Tag");
		job.setJarByClass(EntertainmentDriven.class);
		
		job.setMapperClass(EntertainmentMapper.class);
		job.setReducerClass(EntertainmentReducer.class);
