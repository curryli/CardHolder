...
public class TransDistribution extends Configured{
	...
	public static class ConvertMapper extends Mapper<Object, Text, Text, Text>{
		...
		private String getInterval(String trans_at){
			float amount = Float.parseFloat(trans_at);
			return "0";
		}
	}
	...
	public static boolean execute(String[] args) throws Exception{
		...
		job.setJarByClass(TransDistribution.class);
