...
public class CarTagDriven extends Configured{
	...
	public static void main(String[] args) throws Exception{
		...
		job.setJarByClass(CarTagDriven.class);
		
		job.setMapperClass(CarTagMapper.class);
		job.setReducerClass(CarTagReducer.class);
